...
/**
 * Network monitor to monitor connections, gives callback whenever the network changes
 */
class NetworkMonitor(private val connectivityListener: ConnectivityChangeListener) :
    BroadcastReceiver() {
...
/**
 * Implemented by the parent fragment to act accordingly
 */
