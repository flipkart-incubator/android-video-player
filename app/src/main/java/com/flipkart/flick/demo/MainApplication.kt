...
class MainApplication : MultiDexApplication(), FlickApplicationAdapterProvider {

    override val flickApplicationAdapter: FlickApplicationAdapter
        get() {
            return DemoApplicationAdapter(this)
        }
